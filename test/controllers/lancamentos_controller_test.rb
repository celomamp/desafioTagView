...
class LancamentosControllerTest < ActionController::TestCase
  ...
  test "should create lancamento" do
    assert_difference('Lancamento.count') do
      post :create, lancamento: { data: @lancamento.data, descricao: @lancamento.descricao, user_id: @lancamento.user_id, valor: @lancamento.valor }
    end
  ...
  test "should update lancamento" do
    patch :update, id: @lancamento, lancamento: { data: @lancamento.data, descricao: @lancamento.descricao, user_id: @lancamento.user_id, valor: @lancamento.valor }
    assert_redirected_to lancamento_path(assigns(:lancamento))
  end
